# This file contains FPCA code of other measurements 
# such as Vertical_GRF, Anterior-Posterior GRF (N), COPx_stance, and COPy_stance
...
# Attempt to create the graphs shown for the normalized COPx and COPy
